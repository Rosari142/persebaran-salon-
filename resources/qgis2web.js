...
map.getView().fit([12533167.798835, -887099.791050, 12536718.972535, -885029.043413], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Peta Tematik Persebaran Salon Di Kota Malang</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (745 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Peta tematik persebaran salon di Kota Malang disusun untuk menggambarkan pola distribusi lokasi usaha salon kecantikan berdasarkan wilayah administratif. Data lokasi salon diperoleh melalui survei lapangan dan sumber data pendukung, kemudian diolah menggunakan sistem informasi geografis (SIG). Pemetaan dilakukan untuk mengidentifikasi konsentrasi dan sebaran salon di setiap kecamatan di Kota Malang. Hasil peta tematik menunjukkan bahwa persebaran salon cenderung terkonsentrasi pada kawasan dengan tingkat aktivitas ekonomi dan kepadatan penduduk yang tinggi. Peta ini diharapkan dapat menjadi sumber informasi bagi perencanaan tata ruang, analisis potensi usaha, serta pengambilan keputusan terkait pengembangan sektor jasa di Kota Malang. ';
            }
...
var searchLayer = new SearchLayer({
    layer: lyr_ADMINISTRASI_LN_25K_10,
    colName: 'NAMOBJ',
    zoom: 10,
    collapsed: true,
    map: map,
